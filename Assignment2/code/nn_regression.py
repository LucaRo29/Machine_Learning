...
def calculate_mse(targets, predictions):
    ...
    :return:
    """
    mse = None # TODO Calculate MSE using mean_squared_error from sklearn.metrics (alrady imported)
    return mse
...
def solve_regression_task(features, targets):
    ...
    n_hidden_neurons_list = None # TODO (try at least 3 different numbers of neurons)

    # TODO: MLPRegressor, choose the model yourself

    # Calculate predictions
    y_pred_train = None # TODO
